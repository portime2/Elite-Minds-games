...
const CATEGORIAS = {
  ...
  'Tecnología':   ['computadora','algoritmo','navegador','framework','biblioteca','interfaz','componente','servidor','protocolo','seguridad','teclado','usb','monitor'],
  'Juegos':       ['ahorcado','ajedrez','domino','ruleta','blackjack','solitario','tetris','puzle','laberinto','aventura'],
  'Ciencia':      ['galaxia','protena','neurona','fotosntesis','gravitacion','electron','molecula','isotopo','hidrogeno','carbono','oro,','plata','yodo']
};
const MAX_ERRORES = 6;
